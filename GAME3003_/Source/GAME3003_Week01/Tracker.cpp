...
void ATracker::Tick(float DeltaTime)
{
	...
	VolumeFactor = GetVelocity().Size();
	RollingSound->SetVolumeMultiplier(VolumeFactor * MoveForce * 0.01f);
...
void ATracker::NotifyHit(class UPrimitiveComponent* MyComp, AActor* Other, class UPrimitiveComponent* OtherComp,
